...
<!-- TODO: Add visual abstract image-->
<div style="text-align: center;">
<img src="{{ '/assets/img/velostat/' | relative-url}}" alt="Visual Abstract" style="width: 75%";>
</div>
...
### Research Questions
This material has been used to some success in similar sensing setups, with some examples noted in the "related work" section. However, in the prior art it has been noted that sensors constructed using this material exhibit reliability, hysteresis, and accuracy problems. The scope of this project was to investigate if:
...
<!--TODO: Add composite image of the load cell setup and voltage divider circuit -->
<div style="text-align: center;">
<img src="{{ '/assets/img/velostat/' | relative-url}}" alt="load cell and volt divider" style="width: 75%;">
</div>
...
<div style="text-align: center;">
<img src="{{ '/assets/img/velostat/' | relative-url}}" alt="compressive redesign" style="width: 75%;">
</div>
...
Notice that my fix for the second issue solved more than just that issue, it also contributed to the lack of displacement measurement. Beyond that though, having the open screw  

### Published as

[MDPI sensors](https://www.mdpi.com/1424-8220/25/10/3245)
